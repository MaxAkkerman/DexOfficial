...
function CreatePairConfirmPopup(props) {
    ...
    return (
        <div className="popup-wrapper">
            <MainBlock
                ...
                title={"Create pair confirmation"}
                content={
                    <>
                        <div
                        ...
                        >
                            <div className="confirm_recip_data">
                                <div style={{fontSize:"26px",fontWeight:"500"}}>New pair data</div>
                                <div style={{marginTop: "5px"}}>
                                    <div className={"DeployAssetConfirmPopup__icon_name_block"} style={{flexDirection:"column"}}>
                                        ...
                                        <span className="confirm-value deployAsset" style={{fontSize:"22px",fontWeight:"100",marginTop:"20px"}}>
											{/*{props.currentAsset.symbol}*/}
                                            New pair symbol will be {props.newPairSymbol}
										</span>

                                        <span className="confirm-value deployAsset" style={{fontSize:"22px",fontWeight:"100",marginTop:"20px"}}>
											{/*{props.currentAsset.symbol}*/}
                                            Provide {props.amountA} {props.tokenA.symbol}
										</span>
                                        <span className="confirm-value deployAsset" style={{fontSize:"22px",fontWeight:"100"}}>
											{/*{props.currentAsset.symbol}*/}
                                            Provide {props.amountB} {props.tokenB.symbol}
										</span>
                                        <span className="confirm-value deployAsset" style={{fontSize:"22px",fontWeight:"100",marginTop:"20px"}}>
											{/*{props.currentAsset.symbol}*/}
                                            Expected rate {props.tokenA.symbol}/{props.tokenB.symbol} will be {props.amountA/props.amountB}
										</span>
                                        <span className="confirm-value deployAsset" style={{fontSize:"22px",fontWeight:"100"}}>
											{/*{props.currentAsset.symbol}*/}
                                            Expected rate {props.tokenB.symbol}/{props.tokenA.symbol} will be {props.amountB/props.amountA}
										</span>
                            ...
                            <div style={{width: "100%", marginTop: "20px"}}>
                                ...
                                <div className="DeployAssetConfirmPopup__data">~ 25 EVERs</div>
...
export default CreatePairConfirmPopup;
