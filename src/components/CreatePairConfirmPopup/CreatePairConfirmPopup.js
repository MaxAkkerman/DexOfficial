						...
						>
							<div className="confirm_recip_data">
								...
								<div style={{marginTop: "5px"}}>
									<div
										className={"DeployAssetConfirmPopup__icon_name_block"}
									...
									>
										...
										<span
											className="confirm-value deployAsset"
											style={{
												fontSize: "22px",
												fontWeight: "100",
												marginTop: "20px",
										...
										>
											{/*{props.currentAsset.symbol}*/}
											Expected rate {props.tokenA.symbol}/{props.tokenB.symbol}{" "}
											will be {props.amountA / props.amountB}
										</span>
										<span
											className="confirm-value deployAsset"
											style={{fontSize: "22px", fontWeight: "100"}}
										>
											{/*{props.currentAsset.symbol}*/}
											Expected rate {props.tokenB.symbol}/{props.tokenA.symbol}{" "}
											will be {props.amountB / props.amountA}
										</span>
									</div>
								</div>
							</div>
