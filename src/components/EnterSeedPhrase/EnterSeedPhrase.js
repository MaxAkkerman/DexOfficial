...
import {decrypt, decryptPure, encrypt, encryptPure, verifySeed} from "../../extensions/tonUtils";
...
import {
    ...
    getAllTokensAndSetToStore, getMnemonics, handleCutAddress, InitializeClient,
                ...
                <MainBlock
                    ...
                    content={
                        <>
                            {enterSeedPhraseSide === "login" && (
                                <>
                                    <Grid container onClick={()=>console.log("mnemonicWords",mnemonicWords.length)} spacing={3} sx={{justifyContent: "center"}}>
                                        <Grid item>
                                            <Autocomplete
