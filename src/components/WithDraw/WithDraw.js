...
function WithDraw(props) {
  ...
  const [sendConfirmPopupIsVisible, setsendConfirmPopupIsVisible] =
    useState(false);
  const [showWaitingSendAssetPopup, setshowWaitingSendAssetPopup] =
    useState(false);
                ...
                <div>
                  <div className="send_inputs">
                    <input
                      ...
                      value={
                        addressToSendView ? addressToSendView : addrForWithdraw
                      }
              ...
              <BlockItem
                ...
                rightBottomBlock={
                  <div className="send_set_token_wrap column">
                    <MaxBtn setMAX={() => handleSetMaxAmount()} />
                    <SetTokenBlock
