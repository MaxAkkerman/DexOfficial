    ...
    return (
        <div className="select-wrapper">
            <MainBlock
                ...
                button={props.showCloseBtn ? <CloseBtn
                ...
                content={
                    ...
                    {!props.showCloseBtn ?
                        ...
                        <div className="head_wrapper" style={{marginBottom: "40px"}}>
                            <button className="arrow_back" onClick={() => props.handleGetBack(props.prevStep)}>
                                <img className="arrowImg" src={arrowBack} alt={"arrow"}/>
                            </button>
                            <div className="left_block boldFont">Success!</div>
                        </div>
                        <Grid className="welcomeTextWrapper" style={{height:"59px",margin: "10px auto auto auto"}}>
                            You are registered in DefiSpace
                        </Grid>
                        </>
                        :
                        <>
                        <Grid className="welcomeWrapper">
                            Welcome to DefiSpace!
                        </Grid>
                        <Grid className="welcomeTextWrapper" style={{margin: "10px auto auto auto"}}>
                        ...
                        <Grid className="welcomeAgreementContainer">
                            {props.showCloseBtn ?
                            <>
                            <input className="agreementCheckBox" type="checkbox" onClick={()=>props.handleSignAgreement(!props.agreementSigned)}/>
