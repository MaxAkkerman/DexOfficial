...
function DeployCustomTokenPopup(props) {
    ...
    const [showWaitingDeployCustomPopup, setshowWaitingDeployCustomPopup] = useState(false);
                    ...
                    content={
                        <div>
                            <div className="head_wrapper">
                                ...
                                <div className="left_block boldFont">Deploy from custom root</div>
                            </div>
                            <div
                            ...
                            <div style={{width: "100%", marginTop: "20px",marginLeft: "20px"}}>
                                ...
                                {rootData && <div className="DeployAssetConfirmPopup__data">Root symbol {rootData ? hex2a(rootData.symbol) : "undefined"}</div>}
