...
const BridgeAssets = () => {
    ...
    const approveForWrapper = async () => {
        ...
        const { hash } = await daiContract.approve(
            daiVaultAddress,
            av,
            {
                value: 0
